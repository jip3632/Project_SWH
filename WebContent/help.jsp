	...
	<jsp:include page="/header.jsp"></jsp:include>
   	...
   	<div id="main">
		<div class = "row aln-center" style="margin-bottom:10px;">
			<div class="col-5"><a class="button primary" style="width:100%" type="button" href="">How to</a></div>
			<div class="col-5"><a class="button" style="width:100%" href="">Feedback/Ask</a></div>
		</div>
