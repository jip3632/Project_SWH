...
<article>
	...
	<div>
		...
		<%-- 이벤트 관리 버튼--%>
		<button onclick="location.href = 'eventList.slime?st_uid=<%= arr[0].getSt_uid()%>&page=1'">이벤트 관리</button>
		<%-- 후기 관리 버튼--%>
		<button onclick="location.href = 'reviewListM.slime?st_uid=<%= arr[0].getSt_uid()%>&page=1'">후기 관리</button>
	</div>
</article>
</body>
</html>